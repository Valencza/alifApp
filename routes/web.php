...
Route::get('/product/all-product', function () {
    return view('user.product.allProduct');
})->name('product.allProduct');

Route::get('/product/ac-combo', function () {
    return view('user.product.acCombo');
})->name('product.acCombo');

Route::get('/product/split-wall', function () {
    return view('user.product.splitWall');
})->name('product.splitWall');

Route::get('/product/standing-floor', function () {
    return view('user.product.standingFloor');
})->name('product.standingFloor');

Route::get('/product/commercial/cassette', function () {
    return view('user.product.commercial.cassette');
})->name('product.commercial.cassette');

Route::get('/product/commercial/ducting', function () {
    return view('user.product.commercial.ducting');
})->name('product.commercial.ducting');

Route::get('/product/commercial/vrf', function () {
    return view('user.product.commercial.vrf');
})->name('product.commercial.vrf');

Route::get('/product/commercial/vrv', function () {
    return view('user.product.commercial.vrv');
})->name('product.commercial.vrv');
